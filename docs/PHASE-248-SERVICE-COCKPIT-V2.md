...
| `WORKOS_REFRESH_TIMEOUT_MS`                                                       | no        | R3-D1: hard bound on a provider refresh exchange, default 10000; expiry is TRANSIENT                                                                                                         |
...
| `PG_STATEMENT_TIMEOUT_MS`, `PG_IDLE_IN_TRANSACTION_TIMEOUT_MS`                    | no        | R3-D1: server-side bounds on every pooled connection, default 30000 / 15000; 0 disables. R3-G1: the idle bound's FATAL costs one request (`503 database_connection_lost`), never the process |
...
**Migrations:** `000_platform_core`, `049_phase248_service_cockpit`, `050_phase248_hardening`, `051_phase248_metrics_support`, `052_phase248_authorization_binding`, `053_phase248_estimate_line_association`, `054_phase248_waitlist`, `055_identity_organization`, `056_identity_contract_completion`, `057_identity_boundary_completion`, `058_policy_evidence_reconstructable`, `059_policy_evidence_integrity_closure`, `060_identity_boundary_acceptance_closure`, `061_dealership_administration`, `062_vehicle_acquisition_inventory`, `063_crm_bdc_marketing`, `064_sales_pipeline_showroom`, `065_appraisal_trade_pricing_desking`, `066_deal_jacket_documents_esign`
...
**Error codes:** `already_held`, `amount_invalid`, `amount_required`, `appointment_already_converted`, `approved_terms_frozen`, `artifact_grant_expired`, `assignment_via_dispatch_only`, `authorization_fields_readonly`, `authorization_required`, `body_too_large`, `business_hours_invalid`, `ceremony_closed`, `ceremony_not_complete`, `checklist_incomplete`, `code_required`, `commercial_fields_restricted`, `concurrent_modification`, `configuration_overlap`, `consent_required`, `consent_version_required`, `contradictory_decision`, `csrf_required`, `customer_required`, `database_connection_lost`, `days_required`, `decision_outstanding`, `desking_approval_moved`, `desking_not_approved`, `display_name_required`, `duplicate`, `duplicate_party`, `duplicate_stock_number`, `email_required`, `estimate_not_draft`, `estimate_not_found`, `estimate_not_sent`, `estimate_superseded`, `evidence_required`, `expected_version_invalid`, `expected_version_required`, `features_required`, `floor_empty`, `forbidden`, `idempotency_key_conflict`, `idempotency_key_invalid`, `illegal_transition`, `import_invalid`, `internal_error`, `invalid_appointment_status`, `invalid_request`, `invalid_session_status`, `invalid_time_sequence`, `invalid_transition`, `invitation_invalid`, `line_item_declined`, `line_item_not_found`, `line_items_not_pending`, `location_required`, `malformed_json`, `mixed_currency`, `name_required`, `no_approved_work`, `no_line_items`, `not_found`, `not_inspection_owner`, `not_line_item_assignee`, `not_ticket_assignee`, `offer_already_exists`, `original_ro_not_closed`, `overrides_unsupported`, `package_hash_mismatch`, `package_hash_required`, `parent_required`, `party_ids_required`, `pending_terms_frozen`, `policy_invalid`, `precondition_unmet`, `provider_callback_invalid`, `provider_callbacks_unconfigured`, `provider_signature_invalid`, `queue_item_closed`, `queue_item_taken`, `refused`, `render_failure`, `ro_not_estimable`, `ro_not_estimate_pending`, `ro_not_found`, `ro_not_inspectable`, `role_not_invitable`, `rooftop_invalid`, `route_not_found`, `rows_required`, `rule_overlap`, `rules_unavailable`, `runbook_unsupported`, `scope_id_required`, `scope_level_invalid`, `selection_required`, `self_deactivation_refused`, `severity_required`, `signing_link_expired`, `signing_out_of_order`, `stale_view`, `status_invalid`, `status_not_directly_updatable`, `step_up_rejected`, `step_up_required`, `tech_not_available`, `tenant_mismatch`, `tenant_required`, `ticket_closed`, `to_rooftop_required`, `transfer_already_open`, `unauthorized`, `unavailable`, `unknown_line_items`, `unknown_timezone`, `unknown_view`, `validation_error`, `vehicle_already_stocked`, `version_conflict`, `waitlist_entry_closed`, `waitlist_entry_exists`, `waitlist_not_found`, `waitlist_offer_expired`, `work_incomplete`
