...
| `062_vehicle_acquisition_inventory.sql`        | `7c926823039fbef2f5c43a14464f84025d166ae7` | `755b8baee4fd38d2b66d614ab0a264e1112c7e0bd7dbcf080b61e140ea3c55ae` |
...
created under an explicit audited override stays representable. (2) `resource_org_leaf`
stopped accepting a caller-named tenant as authority — it resolves only within the tenant
the server bound to the transaction, because as a `SECURITY DEFINER` function taking the
tenant as an argument it was an existence-and-location oracle over exactly the rows row
security hides, reachable by anything holding the runtime login. Its batteries are
...
| `scripts/parse-test-summary.ts`              | declared floors **770 / 74**, above every minimum below                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/mutation-kill.ts`                   | **64 declared / 64 killed / 0 survived** — a COMPLETE run of the whole registry, every baseline green, the working tree intact after each. The artifact records WHEN it was taken and WHAT it measured in its own `generated_at`, `head` and `tree_dirty` fields; an earlier run that came back 43 / 1 on a red baseline is disclosed in §2.2 (S6a) rather than dropped                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
**64 declared / 64 killed / 0 survived, 0 baselines red, 0 trees left dirty.** A report that
...
| `scripts/parse-test-summary.ts` | <!--fig:floor_tests-->770<!--/fig--> / <!--fig:floor_suites-->74<!--/fig-->                       | the DECLARED floor, pinned to what this revision actually measured                      |
...
| ---------------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `suite_tests`                | <!--fig:suite_tests-->770<!--/fig-->                                                                      | `artifacts/test-summary.json` `tests`                                               |
| `suite_suites`               | <!--fig:suite_suites-->74<!--/fig-->                                                                      | `artifacts/test-summary.json` `suites`                                              |
| `suite_passed`               | <!--fig:suite_passed-->770<!--/fig-->                                                                     | `artifacts/test-summary.json` `passed`                                              |
| `observed_ok`                | <!--fig:observed_ok-->844<!--/fig-->                                                                      | `artifacts/test-summary.json` `observed_ok_lines`                                   |
| `observed_not_ok`            | <!--fig:observed_not_ok-->0<!--/fig-->                                                                    | `artifacts/test-summary.json` `observed_not_ok_lines`                               |
| `floor_tests`                | <!--fig:floor_tests-->770<!--/fig-->                                                                      | `scripts/parse-test-summary.ts` `MINIMUM_TESTS`                                     |
...
| `mutations_declared`         | <!--fig:mutations_declared-->64<!--/fig-->                                                                | `artifacts/mutation-kill.json` `mutations_total`                                    |
| `mutations_killed`           | <!--fig:mutations_killed-->64<!--/fig-->                                                                  | `artifacts/mutation-kill.json` `mutations_killed`                                   |
| `mutations_survived`         | <!--fig:mutations_survived-->0<!--/fig-->                                                                 | `artifacts/mutation-kill.json` `mutations_survived`                                 |
| `mutations_registered`       | <!--fig:mutations_registered-->64<!--/fig-->                                                              | `scripts/mutation-kill.ts`, `id:` declarations in the registry                      |
...
| `scripts/parse-test-summary.ts`                       | `MINIMUM_TESTS` at 646 under a docstring saying the floor is pinned to the measured run                 | the battery measures <!--fig:suite_tests-->770<!--/fig-->. The constant is raised rather than the docstring softened (§5.1)                                     |
