...
| `scripts/parse-test-summary.ts`              | declared floors **902 / 92**, above every minimum below                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/mutation-kill.ts`                   | **95 declared / 95 killed / 0 survived** — a COMPLETE run of the whole registry, every baseline green, the working tree intact after each. The artifact records WHEN it was taken and WHAT it measured in its own `generated_at`, `head` and `tree_dirty` fields; an earlier run that came back 43 / 1 on a red baseline is disclosed in §2.2 (S6a) rather than dropped                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/database-control-mutations.ts`      | **<!--fig:db_controls_declared-->85<!--/fig--> declared / <!--fig:db_controls_killed-->85<!--/fig--> killed / <!--fig:db_controls_survived-->0<!--/fig--> survived** — each §3 database control DROPPED from a copy of the migrated database, a NAMED test required to die, then restored and required to pass again (§6.1). `controls_filtered` is `false`, so a narrowed diagnostic run cannot stand in for the gate                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
**95 declared / 95 killed / 0 survived, 0 baselines red, 0 trees left dirty.** A report that
...
| `scripts/parse-test-summary.ts` | <!--fig:floor_tests-->902<!--/fig--> / <!--fig:floor_suites-->92<!--/fig-->                       | the DECLARED floor, pinned to what this revision actually measured                      |
...
| `mutations_declared`         | <!--fig:mutations_declared-->95<!--/fig-->                                                                | `artifacts/mutation-kill.json` `mutations_total`                                    |
| `mutations_killed`           | <!--fig:mutations_killed-->95<!--/fig-->                                                                  | `artifacts/mutation-kill.json` `mutations_killed`                                   |
| `mutations_survived`         | <!--fig:mutations_survived-->0<!--/fig-->                                                                 | `artifacts/mutation-kill.json` `mutations_survived`                                 |
| `mutations_registered`       | <!--fig:mutations_registered-->95<!--/fig-->                                                              | `scripts/mutation-kill.ts`, `id:` declarations in the registry                      |
...
registry cannot drift from the file it mutates. <!--fig:db_controls_declared-->85<!--/fig-->
checks, <!--fig:db_controls_killed-->85<!--/fig--> killed, <!--fig:db_controls_survived-->0<!--/fig-->
