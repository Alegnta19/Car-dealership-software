...
| `062_vehicle_acquisition_inventory.sql`        | `0532c479f0c820632cf01f4e175e6f692724b976` | `ab31183daa2bc7add62db33313c1608ad3e4c5ed656393b3f1fcb4f2f58151ab` |
...
employee cannot reach another store's vehicle. Its batteries are
...
| `scripts/parse-test-summary.ts`              | declared floors **763 / 74**, above every minimum below                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/parse-test-summary.ts` | <!--fig:floor_tests-->763<!--/fig--> / <!--fig:floor_suites-->74<!--/fig-->                       | the DECLARED floor, pinned to what this revision actually measured                      |
...
| `scripts/parse-test-summary.ts`                       | `MINIMUM_TESTS` at 646 under a docstring saying the floor is pinned to the measured run                 | the battery measures <!--fig:suite_tests-->763<!--/fig-->. The constant is raised rather than the docstring softened (§5.1)                                     |
