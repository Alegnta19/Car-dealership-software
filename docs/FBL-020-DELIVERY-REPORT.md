...
| `scripts/parse-test-summary.ts`              | declared floors **681 / 65**, above every minimum below                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/mutation-kill.ts`                   | **62 declared / 62 killed / 0 survived** — a COMPLETE run of the whole registry, every baseline green, the working tree intact after each. The artifact records WHEN it was taken and WHAT it measured in its own `generated_at`, `head` and `tree_dirty` fields; an earlier run that came back 43 / 1 on a red baseline is disclosed in §2.2 (S6a) rather than dropped                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `scripts/database-control-mutations.ts`      | **<!--fig:db_controls_declared-->65<!--/fig--> declared / <!--fig:db_controls_killed-->65<!--/fig--> killed / <!--fig:db_controls_survived-->0<!--/fig--> survived** — each §3 database control DROPPED from a copy of the migrated database, a NAMED test required to die, then restored and required to pass again (§6.1). `controls_filtered` is `false`, so a narrowed diagnostic run cannot stand in for the gate                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
**62 declared / 62 killed / 0 survived, 0 baselines red, 0 trees left dirty.** A report that
...
| `scripts/parse-test-summary.ts` | <!--fig:floor_tests-->681<!--/fig--> / <!--fig:floor_suites-->65<!--/fig-->                       | the DECLARED floor, pinned to what this revision actually measured                      |
...
| ---------------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `suite_tests`                | <!--fig:suite_tests-->681<!--/fig-->                                                                      | `artifacts/test-summary.json` `tests`                                               |
| `suite_suites`               | <!--fig:suite_suites-->65<!--/fig-->                                                                      | `artifacts/test-summary.json` `suites`                                              |
| `suite_passed`               | <!--fig:suite_passed-->681<!--/fig-->                                                                     | `artifacts/test-summary.json` `passed`                                              |
| `observed_ok`                | <!--fig:observed_ok-->746<!--/fig-->                                                                      | `artifacts/test-summary.json` `observed_ok_lines`                                   |
| `observed_not_ok`            | <!--fig:observed_not_ok-->0<!--/fig-->                                                                    | `artifacts/test-summary.json` `observed_not_ok_lines`                               |
| `floor_tests`                | <!--fig:floor_tests-->681<!--/fig-->                                                                      | `scripts/parse-test-summary.ts` `MINIMUM_TESTS`                                     |
| `floor_suites`               | <!--fig:floor_suites-->65<!--/fig-->                                                                      | `scripts/parse-test-summary.ts` `MINIMUM_SUITES`                                    |
...
| `mutations_declared`         | <!--fig:mutations_declared-->62<!--/fig-->                                                                | `artifacts/mutation-kill.json` `mutations_total`                                    |
| `mutations_killed`           | <!--fig:mutations_killed-->62<!--/fig-->                                                                  | `artifacts/mutation-kill.json` `mutations_killed`                                   |
| `mutations_survived`         | <!--fig:mutations_survived-->0<!--/fig-->                                                                 | `artifacts/mutation-kill.json` `mutations_survived`                                 |
| `mutations_registered`       | <!--fig:mutations_registered-->62<!--/fig-->                                                              | `scripts/mutation-kill.ts`, `id:` declarations in the registry                      |
...
registry cannot drift from the file it mutates. <!--fig:db_controls_declared-->65<!--/fig-->
checks, <!--fig:db_controls_killed-->65<!--/fig--> killed, <!--fig:db_controls_survived-->0<!--/fig-->
...
| `scripts/parse-test-summary.ts`                       | `MINIMUM_TESTS` at 646 under a docstring saying the floor is pinned to the measured run                 | the battery measures <!--fig:suite_tests-->681<!--/fig-->. The constant is raised rather than the docstring softened (§5.1)                                     |
